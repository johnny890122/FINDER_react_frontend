...
import { example1StepsConfig } from './tourCalculation.config'

export const GuideBlocksForCalculation = ({ step }) => (
  <StyledSlideContainer>
    {Object.values(example1StepsConfig).map(({ id, text }, index) => (
...
GuideBlocksForCalculation.propTypes = {
